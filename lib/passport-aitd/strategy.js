...
/**
 * A wrapper to avoid AccessToken in QueryString instead, just send it in Header for AITD.
 * @param {String} url 
 * @param {Object} header 
 * @param {Object} body
 * @param {Function} callback 
 */
 Strategy.prototype.post = function(url, header, body, callback) {
  this._oauth2._request("POST", url, header, body, "", callback );
};
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this.post(this._userProfileURL, header, data, function (err, body, res) {
