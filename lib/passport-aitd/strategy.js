 ...
 */
Strategy.prototype.post = function(url, header, callback) {
  this._oauth2._request("POST", url, header, "", "", callback );
};
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this.post(this._userProfileURL, header, function (err, body, res) {
